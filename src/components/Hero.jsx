...
const Hero = () => (
    <section style={{ backgroundImage: `url(${BgHero})` }} className="h-dvh bg-cover bg-[position:center_200px] bg-no-repeat bg-black flex items-center justify-center">
        <div className="pb-50 px-4 flex flex-col gap-4">
